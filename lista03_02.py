...
cidade = input("Naturalidade")
ano = int(input("Ano de nascimento"))

print(f"{nome}, nasceu na cidade de {cidade}, em 2030 irá ter {2030-ano} anos")

#("Nome Completo"), nasceu na cidade de ("Naturalidade"), em 2030 irá ter ("{2030-(Ano de nascimento")} anos
